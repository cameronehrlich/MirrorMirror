...
@interface MMViewController () <AVCaptureVideoDataOutputSampleBufferDelegate>
...
- (void)drawFaces:(NSArray *)features forVideoBox:(CGRect)videoBox orientation:(UIDeviceOrientation)orientation;
...
- (void)drawFaces:(NSArray *)features forVideoBox:(CGRect)clearAperture orientation:(UIDeviceOrientation)orientation
{
	...
	CGRect previewBox = [MMViewController videoPreviewBoxForGravity:gravity
	...
	for ( CIFaceFeature *ff in features ) {
        ...
        if (!shapeLayer) {
            ...
            UIColor *color = [UIColor colorWithRed:.2 green:.2 blue:.2 alpha:.2];
            [shapeLayer setFillColor:color.CGColor];
            [shapeLayer setPath:[[UIBezierPath bezierPathWithRect:faceRect] CGPath]];
        ...
        [shapeLayer setAffineTransform:CGAffineTransformMakeRotation(DegreesToRadians(0))];
	}
